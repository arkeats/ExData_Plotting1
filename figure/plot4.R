...
with(df, plot(DT,Voltage,ylab="Voltage",xlab="datetime",type = "l"))
...
legend("topright",cex=0.6, lty=c(1,1,1),col=c("black","red","blue"), legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),bty="n")
with(df, plot(DT, Global_reactive_power,ylab="Global_reactive_power",xlab="datetime",type = "l"))
